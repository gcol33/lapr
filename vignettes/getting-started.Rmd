...
2. **Algorithm selection**: 12+ algorithms with automatic selection based on problem characteristics
3. **Production matching**: High-level matching functions for observational studies (v1.0.0)
4. **Scalability**: From small matrices to thousands of parallel problems
